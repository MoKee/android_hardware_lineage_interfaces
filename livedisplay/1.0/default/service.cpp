...
#define LOG_TAG "vendor.mokee.livedisplay@1.0-service-sdm"
#elif defined(COLOR_BACKEND_LEGACYMM)
#define LOG_TAG "vendor.mokee.livedisplay@1.0-service-legacymm"
#else
...
using ::vendor::mokee::livedisplay::V1_0::implementation::Color;
